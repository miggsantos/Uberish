...
//  Uberish
//
//  Created by Miguel Santos on 20/07/2017.
...
let MSG_PICKUP_MODE_DISABLE = "PICKUP MODE DISABLE"
...
let MSG_PASSENGER_PICKUP = "Passenger Pickup Poin"
...
let ERROR_MSG_EMAIL_ALREADY_IN_USE = "It appears that email is already in use by another user. Please try another email."
...
let ERROR_MSG_WEAK_PASSWORD = "Whoops! That was a weak password. Please try again."
